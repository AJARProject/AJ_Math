...
$test.actual:=String:C10($o.log2(New collection:C1472(-2)))
$test.assert()

$test.given:="passing a collection with more than one element [2,3] as argument"
$test.should:="return "+String:C10(-1/0)
$test.expected:=String:C10(-1/0)  //-INF !!!
$test.actual:=String:C10($o.log2(New collection:C1472(2;3)))
$test.assert()

$test.given:="passsing (1) as argument"
$test.should:="return 0"
$test.expected:=0
$test.actual:=$o.log2(1)
$test.assert()
