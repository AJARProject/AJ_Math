...
$test.actual:=String:C10($o.log10())  // -INF
$test.assert()

$test.given:="text \"NaN\" as argument"
$test.should:="return "+String:C10(-1/0)
$test.expected:=String:C10(-1/0)  //-INF !!
$test.actual:=String:C10($o.log10("NaN"))  // -INF !!!
$test.assert()

$test.given:="passing an empty object {} as argument"
$test.should:="return "+String:C10(-1/0)
$test.expected:=String:C10(-1/0)  //-INF !!!
$test.actual:=String:C10($o.log10(New object:C1471()))
$test.assert()

$test.given:="expression division (100000/1) as argument"
$test.should:="return 5"
$test.expected:=5
$test.actual:=$o.log10(100000/1)
$test.assert()
...
$test.actual:=$o.log10(New collection:C1472(2))
$test.assert()
...
$test.actual:=String:C10($o.log10(New collection:C1472(-2)))
$test.assert()

$test.given:="passing a collection with more than one element [2,3] as argument"
$test.should:="return "+String:C10(-1/0)
$test.expected:=String:C10(-1/0)  //-INF !!!
$test.actual:=String:C10($o.log10(New collection:C1472(2;3)))
$test.assert()

$test.given:="passsing (1) as argument"
$test.should:="return 0"
$test.expected:=0
$test.actual:=$o.log10(1)
$test.assert()
